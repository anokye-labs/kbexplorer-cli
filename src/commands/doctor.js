...
import { readSourceRecord, SOURCE_FILE } from '../lib/source.js';
import { loadPluginManifest, loadExtensionDescriptor, validatePluginManifest, validateExtensionDescriptor, resolveBundle, resolveScopeRoot } from '../lib/plugin-bundle.js';
import { checkRuntime } from '../lib/doctor/runtime.js';
import { checkMcp } from '../lib/doctor/mcp.js';
import { checkTemplate } from '../lib/doctor/template.js';
import { checkAdoption } from '../lib/doctor/adoption.js';
import { checkEnvironment } from '../lib/doctor/env.js';
