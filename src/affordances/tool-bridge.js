...
import { executeAffordance, createAffordanceContext, ACTION_CLASSES } from './index.js';
 ...
 *
 * @param {ReturnType<typeof import('./index.js').describeAffordances>[number]} described
 * @param {object} [opts]
