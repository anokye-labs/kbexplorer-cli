...
repository and produce a JSON catalogue that the `kbexplorer generate`
command transforms into kbexplorer content.
...
kbexplorer links            # investigate warnings
npx kbexplorer dev          # visual smoke test
```
